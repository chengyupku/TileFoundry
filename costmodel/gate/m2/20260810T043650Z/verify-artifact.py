...
def main() -> None:
    ...
    with zipfile.ZipFile(wheel) as archive:
        ...
        for relative in (
            "tilefoundry_costmodel/_serialization.py",
            "tilefoundry_costmodel/api.py",
            "tilefoundry_costmodel/tileop.py",
            "tilefoundry_costmodel/build.py",
            "tilefoundry_costmodel/cli.py",
            "tilefoundry_costmodel/implementations/__init__.py",
            ...
            "tilefoundry_costmodel/profiles/__init__.py",
            "tilefoundry_costmodel/profiles/model.py",
            "tilefoundry_costmodel/profiler/__init__.py",
